...
class Actor:
    ...
    def build_model(self):
        ...
        net = layers.Dense(units=32, activation='relu', kernel_regularizer=regularizers.l2(0.01), bias_regularizer=regularizers.l2(0.01))(states)
        net = layers.Dense(units=64, activation='relu', kernel_regularizer=regularizers.l2(0.01), bias_regularizer=regularizers.l2(0.01))(net)
        net = layers.Dense(units=32, activation='relu', kernel_regularizer=regularizers.l2(0.01), bias_regularizer=regularizers.l2(0.01))(net)
    ...
    #     # BatchNormalization https://stackoverflow.com/questions/34716454/where-do-i-call-the-batchnormalization-function-in-keras
    ...
    #     net = layers.Dense(units=self.action_size)(net)
    #     net = layers.BatchNormalization()(net)
